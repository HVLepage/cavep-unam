...
In this project, we use various remote sensing tools to analyze vegetation characteristics in the Cañete district, Peru. Three levels of data collection are used:
